    ...
    \begin{column}{.45\textwidth}
      \begin{figure}
        \begin{subfigure}{\textwidth}
          \centering
          \fzerobox{\includegraphics[page=1,height=.25\textheight]{support/thesis/sample-report-zh.pdf}}
          \fzerobox{\includegraphics[page=2,height=.25\textheight]{support/thesis/sample-report-zh.pdf}}
          \caption{\textsc{SJTUReport} 课程大论文}
        \end{subfigure}
        \begin{subfigure}{\textwidth}
          \centering
          \fzerobox{\includegraphics[page=1,height=.25\textheight]{support/thesis/sample-article-zh.pdf}}
          \fzerobox{\includegraphics[page=2,height=.25\textheight]{support/thesis/sample-article-zh.pdf}}
