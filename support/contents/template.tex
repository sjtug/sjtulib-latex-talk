...
\begin{frame}
  ...
  \note[item]{项子越的主页 \url{http://www.alanshawn.com/latex3-tutorial/} 有全面的英文版资料，
  甚至还有使用 \LaTeX3 刷 LeetCode 题的例子 \url{http://www.alanshawn.com/advanced-typesetting/}。}
  \note[item]{还有 \url{https://liam.page/2015/01/23/literate-programming-in-latex/} 可供参考。}
\end{frame}
...
\begin{frame}
  ...
  \note{*-ctan.zip 中可以包含 .tds.zip，可以放在 \TeX{} 发行版的 TDS (\TeX{} Directory Structure) 文件目录下，之后刷新文件名数据库。}
