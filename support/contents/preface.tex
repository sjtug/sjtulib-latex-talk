...
\begin{frame}[fragile]
  ...
  \begin{thebibliography}{9}
    ...
    \bibitem{thesisdoc} SJTUG.
    \BOOK{\textsc{SJTUThesis} 用户文档} \TAG{EB/OL}, 2022.
    \newblock \URL{https://github.com/sjtug/SJTUThesis}.

    \bibitem{learnlatex} \LaTeX\ Project.
    C\TeX\ 开发小组~译．
    \BOOK{learnlatex.org} \TAG{EB/OL}, 2022.
    \newblock \URL{https://github.com/CTeX-org/learnlatex.github.io}.

    \bibitem{lshort} \textsc{Oetiker T}, \textsc{Partl H}, \textsc{Hyna I} and \textsc{Schlegl E}.
    C\TeX\ 开发小组~译．
