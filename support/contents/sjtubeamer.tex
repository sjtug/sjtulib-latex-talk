...
\begin{frame}
  ...
  \only<1>{
    \begin{columns}
      ...
      \begin{column}{0.3\textwidth}
        \framebox{\includegraphics[width=\linewidth]{mirrorclone}}
      \end{column}
    \end{columns}
  ...
  \only<2>{
    \begin{columns}
      ...
      \end{column}
      \begin{column}{0.3\textwidth}
        \framebox{\includegraphics[width=\linewidth]{sjtubeamerfirst}}
      \end{column}
    \end{columns}
  }
  ...
  \only<3>{
    \begin{columns}
      ...
      \end{column}
      \begin{column}{0.3\textwidth}
        \framebox{\includegraphics[width=\linewidth]{sjtubeamerdevguidefirst}}
      \end{column}
    \end{columns}
